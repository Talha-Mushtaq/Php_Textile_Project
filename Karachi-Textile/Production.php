	...
	>
     ...
     <!-- <i class="fa fa-code fa-2x"></i>-->
      <h2 class="timer count-title count-number" data-to="50" data-speed="1500"></h2>
       <p class="count-text "style="text-align:center ;">Our Clients</p>
    </div>
	        </div>
              <div class="col-md-4">
               <div class="counter">
     <!-- <i class="fa fa-coffee fa-2x"></i>-->
      ...
      <p class="count-text "style="text-align:center ;">Happy Clients</p>
    </div>
              </div>
              <div class="col-md-4">
                  <div class="counter">
      ...
      <p class="count-text "style="text-align:center ;">Daily Production in (Kg)</p>
    </div></div>
              <!--<div class="col-md-3">
              <div class="counter">
